    ...
    <>
      {
        <div className="flex flex-col justify-between bg-white rounded shadow-lg p-4 sm:p-12 my-auto sm:mx-auto">
          <ToastContainer />
          <h2 className="text-center text-sm sm:text-lg mb-2 font-bold">Изменить товар</h2>
          <form
            autoComplete="off"
          ...
          >
            ...
            <button
              type="submit"
              className="bg-orange-500 text-white text-sm sm:text-base font-bold py-2 px-4 border border-orange-500 rounded cursor-pointer"
            >
              Изменить
            </button>
          </form>
